...
a specified text encoder (GTE, DistilRoBERTa, LLAMA, CLIP, SigLIP).
...
def main():
    ...
    parser.add_argument(
        '--config',
        type=str,
        default='configs/text_encoders/gte_base.yaml',
        help='Path to text encoder config YAML (default: GTE-base)'
    )
