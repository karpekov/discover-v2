#!/bin/bash
# Script to generate all Aruba dataset variations
...
echo ""
echo "==================================================================="
echo "STEP 1: Generating sampled data for Aruba"
echo "==================================================================="

# Fixed-Length sampling configs
FL_CONFIGS=("aruba_FL_20" "aruba_FL_20_p" "aruba_FL_50" "aruba_FL_50_p")

# Fixed-Duration sampling configs
FD_CONFIGS=("aruba_FD_30" "aruba_FD_30_p" "aruba_FD_60" "aruba_FD_60_p" "aruba_FD_120" "aruba_FD_120_p")
...
declare -A CONFIG_TO_DIR=(
    ["aruba_FL_20"]="FL_20"
    ["aruba_FL_20_p"]="FL_20_p"
    ["aruba_FL_50"]="FL_50"
    ["aruba_FL_50_p"]="FL_50_p"
    ["aruba_FD_30"]="FD_30"
    ["aruba_FD_30_p"]="FD_30_p"
    ["aruba_FD_60"]="FD_60"
    ["aruba_FD_60_p"]="FD_60_p"
    ["aruba_FD_120"]="FD_120"
    ["aruba_FD_120_p"]="FD_120_p"
)

# Generate captions for each dataset (train, val, test)
for config in "${ALL_CONFIGS[@]}"; do
    dir="${CONFIG_TO_DIR[$config]}"
    data_dir="data/processed/casas/aruba/${dir}"
...
echo ""
echo "Data location: data/processed/casas/aruba/"
echo "==================================================================="
